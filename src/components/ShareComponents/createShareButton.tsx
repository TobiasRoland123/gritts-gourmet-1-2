...
function createShareButton<OptionProps extends Record<string, any>, LinkOptions extends Record<string, unknown> = OptionProps>(
  networkName: string,
  ...
  type Props = Omit<ShareButtonProps<LinkOptions>, 'forwardedRef' | 'networkName' | 'networkLink' | 'opts'> & OptionProps;
